...
try {
  ...
  urbanParams = require('../frontend/components/ConfiguratorPage/components/ParameterPanel/parameterDefinitionsUrban').parameterDefinitions;
  stepthruParams = require('../frontend/components/ConfiguratorPage/components/ParameterPanel/parameterDefinitionsST').parameterDefinitions;
  mixedParams = require('../frontend/components/ConfiguratorPage/components/ParameterPanel/parameterDefinitions6').parameterDefinitions;
