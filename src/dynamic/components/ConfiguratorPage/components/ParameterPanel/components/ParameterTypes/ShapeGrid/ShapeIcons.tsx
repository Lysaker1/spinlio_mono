export const ShapeIcons = {
    Oval: (
      <svg viewBox="0 0 24 24">
        <ellipse cx="12" cy="12" rx="10" ry="6" fill="none" stroke="white" strokeWidth="2"/>
      </svg>
    ),
    Capsule: (
      <svg viewBox="0 0 24 24">
        <rect x="4" y="8" width="16" height="8" rx="4" fill="none" stroke="white" strokeWidth="2"/>
      </svg>
    ),
    Hexagon: (
      <svg viewBox="0 0 24 24">
        <path d="M12 4L20 8V16L12 20L4 16V8L12 4Z" fill="none" stroke="white" strokeWidth="2"/>
      </svg>
    ),
    Circle: (
      <svg viewBox="0 0 24 24">
    ...
    Triangle: (
      <svg viewBox="0 0 24 24">
        <path d="M12 4L20 18H4L12 4Z" fill="none" stroke="white" strokeWidth="2"/>
      </svg>
    ),
    Square: (
      <svg viewBox="0 0 24 24">
