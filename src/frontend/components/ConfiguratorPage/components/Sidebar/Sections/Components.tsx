import { Button, Divider, Table, Text, TextInput } from "@mantine/core";
import { IconArrowRight, IconBike, IconComponents, IconSearch } from "@tabler/icons-react";
import { useNavigate } from "react-router-dom";
import { BikeTemplate, bikeTemplates } from "../bikeTemplates";
import { CONFIGURATOR_PATHS, ConfiguratorType } from "@frontend/constants/configuratorTypes";
import { ISessionApi, IViewportApi } from "@shapediver/viewer";
import { useEffect, useState } from "react";
import { PREFAB_COMPONENTS, PrefabComponent } from "@frontend/components/dashboard/pages/Marketplace/data/prefabComponents";
