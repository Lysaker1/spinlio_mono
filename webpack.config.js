  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@shared/components': path.resolve(currentPath, '../../shared/components'),
        '@shared/hooks': path.resolve(currentPath, '../../shared/hooks'),
        '@shared/assets': path.resolve(currentPath, '../../shared/assets'),
